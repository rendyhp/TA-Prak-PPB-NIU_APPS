...
import com.example.ta_ppb_niu_apps.databinding.ActivitySignInBinding;
...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Apabila sudah Login maka tidak perlu input lagi
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful() && task.getResult() != null
                        ...
                        preferenceManager.putString(Constants.KEY_USER_INFO, documentSnapshot.getString(Constants.KEY_USER_INFO));
