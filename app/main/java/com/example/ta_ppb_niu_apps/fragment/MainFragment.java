...
import com.example.ta_ppb_niu_apps.activities.SignInActivity;
...
import com.example.ta_ppb_niu_apps.adapters.UsersAdapter;
import com.example.ta_ppb_niu_apps.databinding.FragmentMainBinding;
import com.example.ta_ppb_niu_apps.listeners.ConversionListener;
import com.example.ta_ppb_niu_apps.listeners.UserListener;
...
public class MainFragment extends Fragment implements ConversionListener {
    ...
    public void onViewCreated(View view,  Bundle savedInstanceState) {
        ...
        // Logic code
        preferenceManager = new PreferenceManager(requireContext()); // Use requireContext() instead of getApplicationContext()
        init();
        loadUserDetails();
        getToken();
        setListeners();
    ...
    private void setListeners() {
        ...
        binding.fabNewChat.setOnClickListener(v ->
                startActivity(new Intent(requireContext(), UsersActivity.class)));
    ...
    private void signOut() {
        ...
        documentReference.update(updates)
                .addOnSuccessListener(unused -> {
                    ...
                    requireActivity().startActivity(new Intent(requireContext(), SignInActivity.class));
